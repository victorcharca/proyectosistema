...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 15-12-2020 a las 20:27:58
...
(20, '4', 'Andres Mendoza', 'Chosica, Lurigancho', '2'),
(21, '12989048', 'Omar Corani', 'Av.Ugarte', '17');
...
(1, '123', 'Pedro Hernandez', '77252459', '1', 'em45'),
(2, '123', 'Omar Riquelme', '77252459', '1', 'Om46'),
(3, '123', 'Omar Corani', '70621739', '1', 'owcg21'),
(4, '123', 'Juancito Pinto', '75824685', 'Nvo', 'jp12'),
(5, '777', 'Jorge Luis', '222', '1', 'jorgeAZ');
...
(1, 'Laptop Huawey ', 3000, 15, 'Nvo'),
(2, 'Mouse Logitech 567', 20, 87, '1'),
(3, 'Laptop Lenovo Ideapad 520', 800, 80, '10'),
(4, 'HeadPhones Sony M333', 500, 83, '1'),
(5, 'Procesador Ryzen 3 and 5  Generation4', 1200, 49, 'Nvo'),
(6, 'Teclado Gamer Ultralet 27x0', 200, 20, 'Nvo'),
(7, 'Monitor QBEN', 700, 29, '111');
...
--
ALTER TABLE `detalle_ventas`
  MODIFY `IdDetalleVentas` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=89;
...
--
ALTER TABLE `ventas`
  MODIFY `IdVentas` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
